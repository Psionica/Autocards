...
class QuestionGeneratorPipeline:
    ...
    def __call__(self, inputs: str):
        ...
        output.extend([{'cloze': cl,
                        "note_type": "cloze",
                        "question": "",
                        "answer": ""} for cl in qg_inputs])
        return output
...
class MultiTaskQAQGPipeline(QuestionGeneratorPipeline):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)

    def __call__(self, inputs: Union[Dict, str]):
        if type(inputs) is str:
            # do questiongenerationpipeline
...
SUPPORTED_TASKS = {
    "question-generation": {
        "impl": QuestionGeneratorPipeline,
        "default": {
            "model": "valhalla/t5-small-questiongenerationpipeline-hl",
            "ans_model": "valhalla/t5-small-qa-questiongenerationpipeline-hl",
        }
    },
    "multitask-qa-questiongenerationpipeline": {
        "impl": MultiTaskQAQGPipeline,
        "default": {
            "model": "valhalla/t5-small-qa-questiongenerationpipeline-hl",
        }
    },
    "e2e-questiongenerationpipeline": {
        "impl": E2EQGPipeline,
        "default": {
            "model": "valhalla/t5-small-e2e-questiongenerationpipeline",
        }
    }
}
...
def question_generation_pipeline(
    ...
    if task == "e2e-questiongenerationpipeline":
